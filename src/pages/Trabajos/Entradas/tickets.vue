    ...
    <main class="relative flex w-full flex-1 flex-col items-center overflow-visible bg-black text-white">
        ...
        <div class="mx-auto flex w-full max-w-384 flex-col items-center px-2 text-center">
          <div class="flex max-w-full items-center justify-center gap-2 overflow-visible p-8 sm:gap-5 md:gap-8 lg:gap-10 xl:gap-12">
            <img
              ...
              alt="ESCLAT"
              class="h-auto w-[min(88vw,64rem)] shrink-0 drop-shadow-[0_0_22px_rgba(198,255,51,0.65)]"
            >
      ...
      <section id="tickets" class="relative z-10 w-full px-4 pb-24 md:px-10 lg:px-14">
        <div class="mb-10 w-full text-left">
          ...
          <h2 class="titulo-portada font-black mt-4 text-6xl  leading-none text-white md:text-8xl">
            Acceso al sistema
          </h2>
        </div>
        ...
        <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-3">
          <Card
            ...
            :key="ticket.title"
            class="h-full rounded-none border-2 border-[#c6ff33] bg-transparent text-[#c6ff33] shadow-[6px_6px_0_#c6ff33] transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-[#c6ff33] hover:text-black hover:shadow-[6px_6px_0_#000] "
          >
            <CardHeader class="px-5 pb-0">
              <CardTitle class="titulo-portada font-black text-4xl  leading-none md:text-5xl">
                {{ ticket.title }}
              </CardTitle>
            </CardHeader>
            <CardContent class="px-5 text-base  leading-relaxed md:text-lg">
              <p class="titulo-portada mb-5 font-black text-5xl leading-none md:text-6xl">
                {{ ticket.price }}
              </p>
              <p>{{ ticket.text }}</p>
            </CardContent>
...
Porque en ESCLAT nadie viene a encajar la gente viene a ser.
     ...
     <section id="mapa" class="relative z-10 w-full px-4 py-20 text-white md:px-10 lg:px-14">
      <div class="grid min-h-[82vh] w-full grid-cols-1 overflow-hidden rounded-none border-5 border-[#c6ff33] bg-transparent text-white shadow-[6px_6px_0_#fff] transition-all duration-300 ease-out hover:-translate-y-1 lg:grid-cols-[minmax(0,1.35fr)_minmax(22rem,0.65fr)]">
      <iframe
      ...
      <div class="flex min-h-[35vh] flex-col justify-center border-t-2 border-[#c6ff33]  px-6 py-12 text-left lg:min-h-full lg:border-l-5 lg:border-t-0 lg:px-12">
        <h2 class="titulo-portada text-5xl font-black leading-none text-[#c6ff33]  md:text-7xl lg:text-8xl">
          Donde nos ubicamos
        </h2>
