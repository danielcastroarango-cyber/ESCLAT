...
<template>
  <div class="home-geist flex min-h-screen w-full flex-col items-center text-black">
    ...
    <main class="relative flex w-full flex-1 flex-col items-center overflow-visible bg-black text-white">
      <section
        id="home"
        class="relative z-10 flex min-h-[58vh] w-full items-center justify-center overflow-visible px-4 py-20 text-black md:min-h-[64vh] lg:min-h-[70vh]"
      >
      ...
      <section id="tickets" class=" bg-black relative z-10 w-full px-4 pb-24 md:px-10 lg:px-14">
        ...
        <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-3">
          <Card
            ...
            :key="ticket.title"
            class="h-full rounded-none border-2 border-[#c6ff33] bg-black text-[#c6ff33]  transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-[#c6ff33] hover:text-black  "
          >
     ...
     <p class="text-sm font-bold uppercase tracking-[0.32em] mb-5 text-[#c6ff33] md:text-base">
      ...
      <div id="requerimientos" class="mt-12 grid w-full grid-cols-1 gap-6 border-t-2 border-[#c6ff33] pt-8 text-black/85 md:grid-cols-3">
        <div
