   ...
   <!--  <NavigatorPrimarius class="relative z-10" /> -->
    ...
    <main class="relative z-10 flex flex-1 flex-col items-center justify-center px-2 py-10 md:px-6 lg:px-8">
      ...
      <section class="mb-10 mt-20 flex w-full max-w-384 items-center justify-center gap-3 px-2 md:gap-5">
        <button
          type="button"
          class="grid size-11 shrink-0 place-items-center border-2 border-black bg-white text-black transition hover:-translate-y-0.5 hover:bg-[#c6ff33] hover:border-[#c6ff33] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#c6ff33] md:size-14"
        ...
        <div class="grid min-w-0 flex-1 grid-cols-3 gap-2 md:gap-4">
          <button
            ...
            :class="index === activeDayIndex
              ...
              : 'border-black bg-white text-black hover:border-[#c6ff33] hover:text-[#c6ff33]'"
      ...
      <section
        class="mt-8 grid w-full max-w-440 grid-cols-1 items-start gap-10 md:grid-cols-2 md:gap-8 xl:max-w-none xl:gap-12"
        @mouseleave="hideZone"
      >
        <article class="grid w-full content-start gap-6">
          ...
          <aside
            class="min-h-72 border-2 border-[#c6ff33] bg-black p-5 text-white transition-opacity duration-200 xl:p-7"
            :class="activeZone && activeLevel === 'level1' ? 'block opacity-100' : 'hidden pointer-events-none opacity-0'"
            aria-live="polite"
          >
        ...
        <article class="grid w-full content-start gap-6">
          ...
          <aside
            class="min-h-72 border-2 border-[#c6ff33] bg-black p-5 text-white transition-opacity duration-200 xl:p-7"
            :class="activeZone && activeLevel === 'level2' ? 'block opacity-100' : 'hidden pointer-events-none opacity-0'"
            aria-live="polite"
          >
